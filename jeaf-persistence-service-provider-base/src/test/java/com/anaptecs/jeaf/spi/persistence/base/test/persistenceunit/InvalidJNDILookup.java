...
@PersistenceConfig(
    ...
    containerManagedConnectionDefinition = InvalidJNDILookup.class)

@ContainerManagedConnections(excludeUnlistedClasses = true, nonJTADataSource = "NotExistingDataSource")
public interface InvalidJNDILookup {
