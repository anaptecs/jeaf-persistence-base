...
@PersistenceConfig(
    ...
    containerManagedConnectionDefinition = NonJTAPersistenceUnit.class)

@ContainerManagedConnections(excludeUnlistedClasses = true, nonJTADataSource = "MyNonJTADataSource")
public interface NonJTAPersistenceUnit {
