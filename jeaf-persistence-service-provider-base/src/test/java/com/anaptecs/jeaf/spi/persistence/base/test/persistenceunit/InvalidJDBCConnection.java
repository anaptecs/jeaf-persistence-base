...
@PersistenceConfig(
    ...
    applicationManagedConnectionDefinition = InvalidJDBCConnection.class)

@ApplicationManagedConnections(jdbcDriver = Driver.class, connectionURL = "   \n")
public interface InvalidJDBCConnection {
