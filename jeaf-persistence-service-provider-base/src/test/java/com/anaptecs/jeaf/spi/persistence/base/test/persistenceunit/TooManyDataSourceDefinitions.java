...
@PersistenceConfig(
    ...
    containerManagedConnectionDefinition = TooManyDataSourceDefinitions.class)

@ContainerManagedConnections(excludeUnlistedClasses = false, jtaDataSource = "abc", nonJTADataSource = "xyz")
public interface TooManyDataSourceDefinitions {
